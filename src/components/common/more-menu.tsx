    ...
    >
      <button
        ...
        className={cn(
          ...
          menuOpen && "bg-slate-100 text-slate-900 dark:bg-white/5 dark:text-white"
        )}
        onClick={() => {
          clearCloseTimeout()
      ...
      <div
        className={cn(
          ...
          menuOpen ? "pointer-events-auto translate-x-0 opacity-100" : "pointer-events-none -translate-x-2 opacity-0"
        )}
      >
        <div
          role="menu"
    ...
    <SettingsSheet open={open} onOpenChange={setOpen}>
      <button
        ...
        className={cn(
          ...
          open ? "bg-sky-100 text-sky-700 dark:bg-white/10 dark:text-white" : "text-slate-500 dark:text-white/65"
        )}
      >
