		...
		<aside className="sticky top-0 z-30 hidden h-screen w-[236px] shrink-0 border-r border-white/8 bg-[#0c1620] px-4 py-7 text-white lg:flex lg:flex-col">
						...
						<NavLink
							...
							className={({ isActive }) =>
								cn(
									...
									isActive
										? 'border-lime-400/20 bg-white/6 text-white shadow-[inset_4px_0_0_0_#84cc16]'
										: 'border-transparent text-white/78 hover:bg-white/4 hover:text-white'
								)
							}
						>
			...
			<div className="mt-auto border-t border-white/8 pt-5">
				<SettingsSheet>
					<button
						type="button"
						className="flex w-full items-center justify-between rounded-3xl border border-transparent px-4 py-4 text-left text-base font-semibold text-white/78 transition hover:bg-white/4 hover:text-white"
					>
